      ...
      what3words
        ...
        .then(
          (resolved) => {
            ...
            expect(data.message).to.equal('/autosuggest: missing required parameter "addr"');
            done();
          },
          (rejected) => {
      ...
      what3words
        ...
        .then(
          (resolved) => {
            ...
            expect(data.code).to.equal(400);
            expect(data.message).to.exist;
            expect(data.message).to.equal('/autosuggest: missing required parameter "lang"');
            done();
          },
          (rejected) => {
            console.log(rejected);
